...
gcddb.GCD_DB_USER_PASSWORD="$GCD_DB_USER_PASSWORD"
...
bawdocs.BAWDOCS_DB_USER_PASSWORD="$BAWDOCS_DB_USER_PASSWORD"
...
## Provide the password for the user of Object Store of P8Domain.
bawdos.BAWDOS_DB_USER_PASSWORD="$BAWDOS_DB_USER_PASSWORD"
...
## Provide the password for the user of Object Store of P8Domain.
bawtos.BAWTOS_DB_USER_PASSWORD="$BAWTOS_DB_USER_PASSWORD"
...
## Provide the password for the user of Object Store of P8Domain.
chosdb.CHOS_DB_USER_PASSWORD="$CHOS_DB_USER_PASSWORD"
...
## Provide the password for the user of Object Store of P8Domain. 
aeosdb.AEOS_DB_USER_PASSWORD="$AEOS_DB_USER_PASSWORD"
...
icndb.ICN_DB_USER_PASSWORD="$ICN_DB_USER_PASSWORD"
...
aaedb.APP_ENGINE_DB_USER_PASSWORD="$APP_ENGINE_DB_USER_PASSWORD"
...
bawdb.BAW_RUNTIME_DB_USER_PASSWORD="$BAW_RUNTIME_DB_USER_PASSWORD"
