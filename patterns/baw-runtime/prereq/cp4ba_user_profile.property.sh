...
cpewf=${CPE_OBJ_STORE_ENABLE_WORKFLOW:-"No"}
cpewftablespace=${CPE_OBJ_STORE_WORKFLOW_DATA_TBL_SPACE:-"pg_default"}
cpeconnpoint=${CPE_OBJ_STORE_WORKFLOW_PE_CONN_POINT_NAME:- "pe_conn_point"}
...
CONTENT_INITIALIZATION.CPE_OBJ_STORE_ENABLE_WORKFLOW="$cpewf"

## Specify a table space for the workflow data.
CONTENT_INITIALIZATION.CPE_OBJ_STORE_WORKFLOW_DATA_TBL_SPACE="$cpewftablespace"
...
CONTENT_INITIALIZATION.CPE_OBJ_STORE_WORKFLOW_PE_CONN_POINT_NAME="$cpeconnpoint"
